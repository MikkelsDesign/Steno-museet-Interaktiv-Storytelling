  ...
  function tick() {
    if (--time < 0) {
      ...
      if (score <= 10) {
        ...
        resultDescription =
          "Dit hjerte er i meget dårlig stand! Du bør virkelig tænke over dine valg.";
      } else if (score <= 20) {
        resultImage = "img/Ending2.png";
        resultDescription =
          "Dit hjerte kunne have det bedre. Prøv at tage flere sunde valg.";
      } else if (score <= 30) {
        resultImage = "img/Ending3.png";
        resultDescription =
          "Dit hjerte er i ret god stand! Du er på rette vej.";
      } else {
...
function initLeaderboard() {
  ...
  const entries = JSON.parse(
    localStorage.getItem("stenoLeaderboard") || "[]"
